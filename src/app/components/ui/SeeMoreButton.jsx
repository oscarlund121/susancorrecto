...
const SeeMoreButton = ({ 
  ...
  return (
    <button className={`flex items-center gap-2 sm:gap-3 group-hover:gap-4 transition-all duration-200 ${isLight ? "group-hover:bg-[#DBE1F8]" : "group-hover:bg-[#367067]"} pl-3 pr-2 py-1 rounded-full`}>
      <span
