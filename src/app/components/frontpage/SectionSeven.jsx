    ...
    <div className="py-32 bg-white">
      ...
      <div className="flex flex-col md:flex-row items-center justify-around gap-1 mt-16">
        <Help
          ...
          tags={["Eksamensangst & studieproblemer", "Relationer", "Økonomi", "Gruppedannelser & sociale udfordringer", "Overgang til voksenlivet", "Identitetsudvikling"]}
        />
        <Help
          title="Stress & Udmattelse"
          tags={["Stress & udbrændthed", "Søvnproblemer", "Tankemylder & negative tankemønstre", "Udmattelse", "Koncentrationsvanskeligheder", "Præstationsangst"]}
        />
      </div>
      <div className="flex flex-col md:flex-row items-center justify-around gap-1 mt-16">
        <Help
        ...
        <Help
          ...
          tags={["Lavt selvværd & selvtillid", "Følelse af at være forkert", "Negative mønstre", "Sensitivitet & overfølsomhed", "Selvkritik & perfektionisme", "Usikkerhed & selvtvivl"]}
        />
      </div>
      <div className="flex flex-col md:flex-row items-center justify-around gap-1 mt-16">
        <Help
          title="Relationer & Familie"
          tags={["Kommunikationsproblemer", "Forældrevejledning", "Social angst & ensomhed", "Skilsmisse & separation", "Parforhold", "Familiekonflikter & uro i familien"]}
        />
        <Help
