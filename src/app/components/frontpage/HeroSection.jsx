...
const HeroSection = () => {
  return (
    <div className="relative section min-h-screen pb-16 ">
      {/* Background image */}
      <Image
      ...
      {/* Hero content */}
      <div className="relative z-20 flex items-center justify-left content-max  pt-20">
        <div className="text-left text-white">
          {/* Add your hero content here */}
          <h1 className="mb-4">Terapi der giver dig frihed til at leve fuldt ude</h1>
        </div>
      </div>
