  ...
  return (
    <div>
      ...
      <div className="bg-[#DBE1F8] py-32">
        <div className="mb-16">
          <HeaderSection
            title="Meditation - placeholder titel"
            text="Placeholder tekst for meditation. Denne tekst skal erstattes med den korrekte beskrivelse af meditation og dens fordele."
            buttonHref="/kontakt"
            variant="primary"
            borderColor="black"
          />
            ...
            <div>
              <div>
                ...
                <p className="sm:w-xl w-sm mt-6">
                  Placeholder tekst om meditation. Denne beskrivelse skal erstattes med korrekt information om meditation, dens anvendelse og fordele.
                </p>
              </div>
              <Help
              ...
              <div>
                ...
                <div className="mt-8">
                  ...
                  <div className="sm:w-xl w-sm mb-8 ">
                    <p>
                      Placeholder tekst om hvordan et meditation forløb foregår. Denne tekst skal erstattes med korrekt information om meditation processen.
                    </p>
                    <br />
                    <p>
                      Kontakt mig for en uforpligtende samtale om, hvordan meditation kan hjælpe dig.
                    </p>
                  </div>
                  <Button
                    variant="secondary" />
