...
export default function Meditation() {
  return (
    <div>
      ...
      <HelpPageCTA
        text="Vi starter altid med en indledende samtale, hvor vi afklarer hvad der fylder mest for dig. Kontakt mig for en uforpligtende samtale om, hvordan meditation kan hjælpe dig med at finde ro og balance."
      />
    </div>
  );
}