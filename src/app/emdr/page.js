  ...
  return (
    <div>
      ...
      <div className="bg-[#DBE1F8] py-32">
        <div className="mb-16">
          <HeaderSection
            title="EMDR terapi - placeholder titel"
            text="Placeholder tekst for EMDR terapi. Denne tekst skal erstattes med den korrekte beskrivelse af EMDR metoden og dens fordele."
            buttonHref="/kontakt"
            variant="primary"
            borderColor="black"
          />
            ...
            <div>
              <div>
                ...
                <p className="sm:w-xl w-sm mt-6">
                  Placeholder tekst om EMDR terapi. Denne beskrivelse skal erstattes med korrekt information om metoden, dens anvendelse og fordele.
                </p>
              </div>
              <Help
              ...
              <div>
                ...
                <div className="mt-8">
                  ...
                  <div className="sm:w-xl w-sm mb-8 ">
                    <p>
                      Placeholder tekst om hvordan et EMDR forløb foregår. Denne tekst skal erstattes med korrekt information om EMDR processen.
                    </p>
                    <br />
                    <p>
